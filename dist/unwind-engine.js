...
export class UnwindEngine {
    ...
    walrusLogger;
    config;
    constructor(naviClient, walrusLogger, config) {
     ...
     */
    calculateRepayAmount(snapshot, targetHF) {
    ...
    async execute(snapshot, rule) {
        const { debtToRepay, collateralToWithdraw, debtSymbol, collateralSymbol } = this.calculateRepayAmount(snapshot, rule.targetHF);
...
//# sourceMappingURL=unwind-engine.js.map